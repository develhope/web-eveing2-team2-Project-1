        ...
        <footer className="site-footer" role="contentinfo" aria-label="Footer">
            <div className="footer-container">
                ...
                <nav className="footer-section" aria-label="Servizi">
                    <h4>Servizi</h4>
                    <ul>
                        <li><a href="#destinazioni">Web Design</a></li>
                        <li><a href="#modi-di-viaggiare">Sviluppo</a></li>
                        <li><a href="#tipodivacanza">Marketing</a></li>
                        <li><a href="#viaggiaperstagione">Nuovo Servizio</a></li>
                    </ul>
                </nav>
